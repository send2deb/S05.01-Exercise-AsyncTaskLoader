...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private String[] mCachedWeatherResult;
    private static final int WETHAER_LOADER_ID = 64;
...
//        new FetchWeatherTask().execute(location);
        ...
        Loader<String[]> weatherLoader = loaderManager.getLoader(WETHAER_LOADER_ID);
        if (weatherLoader == null) {
            loaderManager.initLoader(WETHAER_LOADER_ID,bundle,this);
        } else {
            loaderManager.restartLoader(WETHAER_LOADER_ID,bundle,this);
        }
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            protected void onStartLoading() {
                ...
                if(mCachedWeatherResult != null) {
                    deliverResult(mCachedWeatherResult);
                } else {
